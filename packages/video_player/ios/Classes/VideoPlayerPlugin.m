...
@property(nonatomic, strong) NSDictionary* dictHeaders;
- (instancetype)initWithURL:(NSURL*)url frameUpdater:(FLTFrameUpdater*)frameUpdater;
- (instancetype)initWithURL:(NSURL*)url frameUpdater:(FLTFrameUpdater*)frameUpdater andHeaders:(NSDictionary*) headers;
- (void)play;
- (void)pause;
        ...
        if (assetArg) {
            ...
            if(headers){
                player = [[FLTVideoPlayer alloc] initWithURL:[NSURL URLWithString:uriArg]
                                                frameUpdater:frameUpdater andHeaders:headers];
            }else{
                player = [[FLTVideoPlayer alloc] initWithURL:[NSURL URLWithString:uriArg]
